...
/* Official WhatsApp glyph. lucide-react dropped brand icons, so the
   path is inlined here rather than pulling in a whole icon package. */
function WhatsAppGlyph({ className = "w-7 h-7" }) {
  return (
